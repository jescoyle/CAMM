## This script restarts the community assembly of mutualists model (CAMM) on a set of parameter files
...
for(f in file_list){
	...
	# Run CAMM
	model_out = run_camm_N(parm_file, nruns, nchains, ncores, sim_parms, simID=runID, save_start=T, save_sim=T, save_dir=results_dir, restart=T, sim_dir=sim_dir) 
